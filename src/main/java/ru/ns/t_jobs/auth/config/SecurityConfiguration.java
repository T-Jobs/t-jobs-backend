...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        String[] hrPaths = {"/user/tracks", "/vacancy/create", "/vacancy/edit/**",
                "/track/approve-application", "/track/decline-application", "/track/create", "/track/set-hr", "/track/finish",
                "/interview/set-interviewer", "/interview/set-auto-interviewer", "/interview/set-date",
                "/interview/set-auto-date", "/interview/set-link", "/interview/add-to-track", "track/continue"};
